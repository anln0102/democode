        ...
        <div class="content-home">
            ...
            <div class="list-item">
                <div class="container-fluid">
                    ...
                    <?php foreach ($result as $key => $f) : ?>
                        <div class="modal fade" id="<?php echo $f["student_code"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel" style="color:cornsilk">報告書の詳細</h5>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <div class="show-report">
                                                                        ...
                                                                        <p><span>感想及び先輩へのアドバイス:&nbsp;</span><?php echo $f["advice"] ?>
                                                                        </p>
                                                                    </div>
                                                                </th>
