                                        ...
                                        <?php foreach ($students as $key => $student) : ?>
                                            <tr>
                                                ...
                                                <td class="function-student">
                                                    <a class="btn-primary" style="border-radius: 5px; height: 50px;padding: 11px 15px;padding-top: 5px;" href="index.php?view=update-share-experience&student_code=<?php echo $student['student_code'] ?>">編集</a>
                                                    <a href="#" class="btn btn-danger" onclick="deleteStudent('<?php echo $student['student_code'] ?>')">削除</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
