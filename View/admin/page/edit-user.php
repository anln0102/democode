...
if (isset($_POST['name'])) {
    ...
    header('Location: http://localhost/hokokusho2021/view/admin/index.php?view=user');
    } else {
        echo " <script>alert('編集出来ませんでした！')
        </script>";
     }
    $conn->close();
    // header('localhost: http://hokokusho2021.localhost/view/admin/index.php?view=user');
}
